...
<script type="text/javascript">
	...
	function backToList(obj) {
		obj.action = "${contextPath}/Movie/listFile.do";
		obj.submit();
	}
</script>
<title>새글 쓰기 창</title>
...
<body>
	...
	<form name="fileForm" method="post" action="${contextPath}/Movie/addFile.do" enctype="multipart/form-data">
